...
The theorem does not say how to construct the network, therefore the layer may be infeasibly large and may fail to learn and generalize correctly. From practical perspective it is recommended to use deeper (having more layers) rather than wider networks \cite{Relu_regions}. 
