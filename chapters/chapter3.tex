...
\begin{figure}
\begin{tabular}{c}
\subfloat{{\includegraphics[width=\textwidth]{figures/Shap_overall.png} }}%
\\
\subfloat{{\includegraphics[width=\textwidth]{figures/Shap_mean.png}}}%
\end{tabular}
...
\section{Final machine learning model to select best downstream track candidates}
